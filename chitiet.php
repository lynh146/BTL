...
mysqli_query($conn, "UPDATE restaurants SET count = count + 1 WHERE id = $id");
...
?>
  ...
  <div class="hours-box">
    ...
    <ul>
      <?php
      $hours = mysqli_query($conn, "SELECT * FROM opening_hours WHERE restaurant_id = $id");
  ...
  <div class="back-link">
    <a href="quannoi.php">← Quay lại danh sách quán nổi bật</a>
  </div>
<script>
